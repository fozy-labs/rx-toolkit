...
const serverTodos: TodoItem[] = [
    { id: 1, text: 'Изучить RxToolkit v2' },
    { id: 2, text: 'Попробовать CommandV2' },
...
const addTodoCommand = api.createCommandV2<{ text: string }, TodoItem>({
    queryFn: async (args) => {
...
export function Base() {
    ...
    const [trigger, commandState] = addTodoCommand.useCommandV2Agent();
        ...
        <Card>
            ...
            <CardBody className="space-y-4">
                ...
                <p className="text-xs text-default-400 text-center">
                    createApi → createCommandV2 + createResourceV2 → useCommandV2Agent — добавление элемента с инвалидацией ресурса
                </p>
            </CardBody>
        </Card>
    );
