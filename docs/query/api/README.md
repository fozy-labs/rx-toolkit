...
- **Низкоуровневый `$queryFulfilled`** (контекст `onQueryStarted`) реджектится **сырой** ошибкой — он отражает необработанный исход запроса; нормализованная ошибка появляется на состоянии и в реджекте мутации.
