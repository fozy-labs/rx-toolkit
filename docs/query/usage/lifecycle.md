...
Хуки жизненного цикла позволяют реагировать на события кеш-записей.
...
|---|-------------------------------------|---------------------------------------------------------------------------------------------------------|
| `entry` | `CacheEntry` (ресурса или комманды) | Текущая кеш-запись.                                                                                     |
| `$cacheDataLoaded` | `Promise<TData>`                    | Разрешается при первом успешном ответе. Отклоняется, если запись удалена до успещного получения данных. |
| `$cacheEntryRemoved` | `Promise<void>`                     | Разрешается при удалении записи из кеша.                                                                |
