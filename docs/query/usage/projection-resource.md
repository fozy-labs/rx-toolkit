...
| `invalidate()` | Перевалидировать всю ленту: страницы с данными — invalidate, упавшие — retry. |
