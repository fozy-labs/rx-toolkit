...
describe('QueriesLifetimeHooks', () => {
  ...
  describe('onQueryStarted', () => {
    it('calls listener with args and tools', () => {
      ...
      expect(listener).toHaveBeenCalledWith('test-args', expect.objectContaining({
  ...
  describe('onCacheEntryAdded', () => {
    it('calls listener with args and tools', () => {
      ...
      expect(listener).toHaveBeenCalledWith('cache-args', expect.objectContaining({
    ...
    it('dataChanged$ completes when cacheEntryRemoved is resolved', async () => {
      ...
      let completed = false;
      resolvers.dataChanged$.subscribe({ complete: () => { completed = true; } });
