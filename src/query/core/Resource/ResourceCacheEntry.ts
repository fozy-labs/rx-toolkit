...
import { MachineError, MachinePending, MachineRefreshing, MachineSuccess, Patcher } from "@/query/core/machines";
import type {
...
export interface IResourceCacheEntryOptions<TArgs, TData> {
    args: TArgs;
    argsKey: string;
...
/**
 * ResourceCacheEntry — extends CacheEntry with query lifecycle,
 ...
 */
export class ResourceCacheEntry<TArgs, TData>
    extends CacheEntry<TMachineInstance<TArgs, TData>>
    implements IResourceCacheEntry<TArgs, TData>
{
