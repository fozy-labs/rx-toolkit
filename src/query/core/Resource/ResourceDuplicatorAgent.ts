...
export class ResourceDuplicatorAgent<D extends DuplicatorDefinition> implements ResourceAgentInstance<
    D["RESOURCE_DEFINITION"]
> {
    ...
    constructor(private _resource: ResourceDuplicator<D>) {}
