...
test("PL10: augmented resource does not expose non-existent methods", () => {
    ...
    // useResourceAgent is contributed by ReactHooksPlugin
    ...
    expectTypeOf(resource.useResourceAgent).returns.toEqualTypeOf<
        TResourceAgentState<{ id: number }, { name: string }>
    >();
