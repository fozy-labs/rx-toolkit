import type { ArgsOrVoid, ICommandV2Agent, TCommandV2AgentState } from "@/query-v2/types";
...
function deriveAgentState<TArgs, TResult>(
    entry: CommandV2CacheEntry<TArgs, TResult> | null,
): TCommandV2AgentState<TArgs, TResult> {
    if (!entry) {
        return {
            status: "idle",
            data: null,
...
export class CommandV2Agent<TArgs, TResult> implements ICommandV2Agent<TArgs, TResult> {
    ...
    private _key: symbol;
    private _entry$ = Signal.state<CommandV2CacheEntry<TArgs, TResult> | null>(null);
    ...
    constructor(command: CommandV2<TArgs, TResult>, key: symbol) {
        ...
        this.state$ = Signal.compute<TCommandV2AgentState<TArgs, TResult>>(() => {
        ...
        }) as ComputeFn<TCommandV2AgentState<TArgs, TResult>>;
    }
